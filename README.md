...
1. Place the masks in `path_to_data_dir/Annotations/480p` and the DAVIS frames in `path_to_data_dir/JPEGImages/480p`. There are 3 parts of the method criterion 1, criteria 2, stage 3. 
2. Place the downloaded weights of STM and selecto_net in `checkpoints` folder.
3. Evaluate using criterion 1 by executing `run.sh`. 
